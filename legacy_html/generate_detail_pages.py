...
extra_pages = {
    'services/pmc': 'services-pmc.html',
    'services/transport-installation': 'services-ti.html',
    'services/asset-integrity': 'services-asset-integrity.html',
    'project/pro2504-mpl': 'project-flowline.html',
    'project/santos-kumul-marine-terminal-maintenance-2025': 'project-kumul.html',
    'project/santos-calm-buoy-inspection-maintenance-2024': 'project-calm.html',
    'project/santos-platform-maintenance-2024': 'project-platform.html'
}
...
replacements = [
    ...
    ('href="/services/pmc"', 'href="/services-pmc.html"'),
    ('href="/services/transport-installation"', 'href="/services-ti.html"'),
    ('href="/services/asset-integrity"', 'href="/services-asset-integrity.html"'),
    ('href="/project/pro2504-mpl"', 'href="/project-flowline.html"'),
    ('href="/project/santos-kumul-marine-terminal-maintenance-2025"', 'href="/project-kumul.html"'),
    ('href="/project/santos-calm-buoy-inspection-maintenance-2024"', 'href="/project-calm.html"'),
    ('href="/project/santos-platform-maintenance-2024"', 'href="/project-platform.html"')
]

headers = {'User-Agent': 'Mozilla/5.0'}

for slug, local_filename in extra_pages.items():
